...
import GallerieGridItem from "./GallerieGridItem"
...
const Home = props => {
    ...
    <Container className=" d-flex justify-content-between align-items-center">
      ...
      <Container className="d-flex justify-content-end align-items-center">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="white" className="bi bi-justify-left border border-1 p-2" viewBox="0 0 16 16">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="white" className="bi bi-grid border border-1 p-2" viewBox="0 0 16 16">
...
<Carousel>
    <GallerieGridItem filmName="harry"/>
    </Carousel>
        </>
    )
}
